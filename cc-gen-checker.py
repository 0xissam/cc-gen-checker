...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "CC gen checker"))
        self.label_6.setText(_translate("MainWindow", "developed by 0xissam"))
    ...
    def generate(self):
        ...
        yeras = ['2023', '2024', '2025', '2026', '2027', '2028', '2029', '2030','2031']
        ...
        for i in cc_card_list:
            ...
            cvv = ''.join((random.sample(degits, 3)))
            self.textEdit_generated.insertPlainText(f'[ + ] {i}|{monttt}|{yearttt}|{cvv}\n')
            self.textEdit_generated.repaint()
        ...
        for i in valid_cc:
            ...
            self.textEdit.insertPlainText(f'[ Live] {i}|{monttt}|{yearttt}|{cvv}\n')  # [    Live    ]
            self.textEdit.repaint()
        ...
        for i in died_cc:
            ...
            self.textEdit.insertPlainText(f'[ Die ] {i}|{monttt}|{yearttt}|{cvv}\n')
            self.textEdit.repaint()
